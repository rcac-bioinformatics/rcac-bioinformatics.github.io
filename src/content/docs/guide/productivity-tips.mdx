...
:::note[Reference]
📄 **[View Quick Reference (PDF)](https://www.google.com/search?q=/assets/vscode-remote-ssh.pdf)** *Includes configurations for Jupyter Kernels and R paths.*
:::
...
📄 **[View Quick Reference (PDF)](https://www.google.com/search?q=/assets/RCAC_conda-package-management.pdf)** *Includes visual workflows for creating vs. using environments and version pinning examples.*
...
📄 **[View Quick Reference (PDF)](https://www.google.com/search?q=/assets/RCAC_apptainers-for-software-management.pdf)** *Includes recipes for building your own containers and advanced bind-mount usage.*
...
📄 **[View Quick Reference (PDF)](https://www.google.com/search?q=/assets/RCAC_project-organization-tips.pdf)** *Includes a step-by-step workflow for starting a new project.*
...
📄 **[View Quick Reference (PDF)](https://www.google.com/search?q=/assets/RCAC_data-transfer-tips.pdf)** *Includes detailed setup for Globus Connect Personal.*
...
📄 **[View Quick Reference (PDF)](https://www.google.com/search?q=/assets/rmarkdown-2.0.pdf)** *Official reference for syntax, chunk options, and formatting.*
...
📄 **[View Quick Reference (PDF)](https://www.google.com/search?q=/assets/RCAC-github-projects.pdf)** *Includes branching workflows and a list of Git "Don'ts".*
...
📄 **[View Quick Reference (PDF)](https://www.google.com/search?q=/assets/RCAC-slurm-quick-reference.pdf)** *Includes detailed syntax for GPU jobs and parameter sweeps.*
