...
📄 **[View Quick Reference (PDF)](/assets/RCAC_apptainers-for-software-management.pdf)** *Includes recipes for building your own containers and advanced bind-mount usage.*
...
📄 **[View Quick Reference (PDF)](/assets/RCAC_project-organization-tips.pdf)** *Includes a step-by-step workflow for starting a new project.*
...
📄 **[View Quick Reference (PDF)](/assets/RCAC_data-transfer-tips.pdf)** *Includes detailed setup for Globus Connect Personal.*
...
📄 **[View Quick Reference (PDF)](/assets/rmarkdown-2.0.pdf)** *Official reference for syntax, chunk options, and formatting.*
...
📄 **[View Quick Reference (PDF)](/assets/RCAC-github-projects.pdf)** *Includes branching workflows and a list of Git "Don'ts".*
...
📄 **[View Quick Reference (PDF)](/assets/RCAC-slurm-quick-reference.pdf)** *Includes detailed syntax for GPU jobs and parameter sweeps.*
