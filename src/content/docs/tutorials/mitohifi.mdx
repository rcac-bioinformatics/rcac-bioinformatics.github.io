...
description: Mitochondrial genomes can be assembled from long reads (PacBio HiFi) using mitohifi. This guide provides a quick tutorial on how to do this.
...
![Fig1](/assets/figures/final_mitogenome.annotation.png)

**Figure 1: Predicted genes throughout the final mitogenome**


![Fig2](/assets/figures/final_mitogenome.coverage.png)
