...
![Busco results](public/assets/figures/braker_busco_figure.png)
...
<TabItem label="Sn/Pr">
![Assigned features](public/assets/figures/braker_mikado_compare_with_isoforms.png)
</TabItem>

<TabItem label="Missed/Novel">
![Unassigned features](public/assets/figures/braker_mikado_compare_with_isoforms_counts.png)
</TabItem>
...
<Tabs>
<TabItem label="Sn/Pr">
![Assigned features](public/assets/figures/braker_mikado_compare_without_isoforms.png)
</TabItem>

<TabItem label="Missed/Novel">
![Unassigned features](public/assets/figures/braker_mikado_compare_without_isoforms_counts.png)
</TabItem>
...
<TabItem label="Assigned features">

![Assigned features](public/assets/figures/braker_assigned.png)
</TabItem>

<TabItem label="Unassigned features">

![Unassigned features](public/assets/figures/braker_unassigned.png)
</TabItem>
...
<TabItem label="Pfam domains">

![Pfam Domains](public/assets/figures/braker_pfam-domain.png)
</TabItem>

<TabItem label="Functional annotation">

![Functional Annotation](public/assets/figures/braker_gene-function.png)
</TabItem>

<TabItem label="Percent Identity">

![Percent identity](public/assets/figures/braker_pid.png)
</TabItem>
...
<TabItem label="Phylostrata counts">

![Assigned features](public/assets/figures/braker_ps_counts.png)
</TabItem>

<TabItem label="Phylostrata percentages">

![Unassigned features](public/assets/figures/braker_ps_percent.png)
</TabItem>
...
![GFF3 stats](public/assets/figures/braker_summary_stats.png)

### G. OMArk assesment

<Tabs>

<TabItem label="Conserved Genes">

![braker consistency](public/assets/figures/braker_consistency.png)
</TabItem>

<TabItem label="Conserved HOGs">

![braker_conservedHOGs](public/assets/figures/braker_conservedHOGs.png)
</TabItem>
...
<TabItem label="GC distribution">

![braker_cds-gc](public/assets/figures/braker_cds-gc.png)
</TabItem>

<TabItem label="Length distribution">

![braker_cds-length](public/assets/figures/braker_cds-length.png)
</TabItem>


<TabItem label="GC content">

![braker_gc-content](public/assets/figures/braker_gc-content.png)
</TabItem>

<TabItem label="Codon type">

![braker_codon-type](public/assets/figures/braker_codon-type.png)
</TabItem>
