...
description: A short guide to assemble genomes from long reads (PacBio HiFi) using HiFiasm.
...
![Fig1](/assets/figures/hifiasm_hap1_bandage.png)
...
![Fig2](/assets/figures/hifiasm_hap2_bandage.png)
...
| # N's per 100 kbp                     |          0 |          0 |
  ...
  <TabItem label="purge level 3 (default)">
...
<details>
<summary>1. What other options are available in `hifiasm` that affect the assembly?</summary>
...
<details>
<summary>2. Why did I get two haplotypes in the output?</summary>
...
<details>
<summary>3. I have too many small contigs/fragmented assembly, how can I reduce them?</summary>
...
<details>
<summary>4. My assembly as shown in Bandage has a lot of bubbles/loops, how can I resolve them?</summary>
...
<details>
<summary>5. I've more questions! Where can I find more information?</summary>
