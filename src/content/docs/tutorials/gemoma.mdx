...
<CardGrid>
  ...
  <Card title="Software" icon="information">
...
![Busco results](public/assets/figures/gemoma_busco_figure.png)
...
The plots were generated using the following R script: [`cds_assesment.R`](public/assets/scripts/gemoma_cds_assesment.R)

<Tabs>

  <TabItem label="CDS length">

![cds length](public/assets/figures/gemoma_cds-length.png)
...
![GC content](public/assets/figures/gemoma_gc-content.png)
...
![codon type](public/assets/figures/gemoma_codon-type.png)
