...
description: Generate `.hic` contact maps using Juicer Hi-C processing pipeline on the Negishi Cluster.
lastUpdated: 2025-05-22
tableOfContents:
  minHeadingLevel: 2
  maxHeadingLevel: 4
---
import { FileTree, Aside, Card, CardGrid, Steps, Icon } from '@astrojs/starlight/components';
...
<details>
<summary>How does the stdout look like for successful run? [click to show answer]</summary>
